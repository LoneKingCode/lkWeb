...
namespace lkWeb.Service.Abstracts
{
    public partial interface ISys_InfoTypeService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_InfoTypeDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_InfoTypeDto>> GetListAsync(Expression<Func<Sys_InfoTypeDto, bool>> queryExp);
	}
}
