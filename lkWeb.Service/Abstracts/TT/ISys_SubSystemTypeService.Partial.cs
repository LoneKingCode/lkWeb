...
namespace lkWeb.Service.Abstracts
{
    public partial interface ISys_SubSystemTypeService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_SubSystemTypeDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_SubSystemTypeDto>> GetListAsync(Expression<Func<Sys_SubSystemTypeDto, bool>> queryExp);
	}
}
