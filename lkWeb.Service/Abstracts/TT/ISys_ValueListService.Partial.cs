...
namespace lkWeb.Service.Abstracts
{
    public partial interface ISys_ValueListService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_ValueListDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_ValueListDto>> GetListAsync(Expression<Func<Sys_ValueListDto, bool>> queryExp);
	}
}
