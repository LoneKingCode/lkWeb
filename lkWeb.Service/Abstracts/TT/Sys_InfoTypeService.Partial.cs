...
namespace lkWeb.Service.Abstracts
{
    public partial class Sys_InfoTypeService : ServiceBase<Sys_InfoTypeEntity>, ISys_InfoTypeService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_InfoTypeDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_InfoTypeDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_InfoTypeEntity>();
                var result = new ResultDto<Sys_InfoTypeDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_InfoTypeDto>> GetListAsync(Expression<Func<Sys_InfoTypeDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
