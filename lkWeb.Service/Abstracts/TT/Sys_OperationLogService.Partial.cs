...
namespace lkWeb.Service.Abstracts
{
    public partial class Sys_OperationLogService : ServiceBase<Sys_OperationLogEntity>, ISys_OperationLogService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_OperationLogDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_OperationLogDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_OperationLogEntity>();
                var result = new ResultDto<Sys_OperationLogDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_OperationLogDto>> GetListAsync(Expression<Func<Sys_OperationLogDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
