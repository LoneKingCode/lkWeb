...
namespace lkWeb.Service.Abstracts
{
    public partial class Sys_TableColumnService : ServiceBase<Sys_TableColumnEntity>, ISys_TableColumnService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_TableColumnDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_TableColumnDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_TableColumnEntity>();
                var result = new ResultDto<Sys_TableColumnDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_TableColumnDto>> GetListAsync(Expression<Func<Sys_TableColumnDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
