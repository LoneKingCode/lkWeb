...
namespace lkWeb.Service.Services
{
    public partial interface ISys_DepartmentService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_DepartmentDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_DepartmentDto>> GetListAsync(Expression<Func<Sys_DepartmentDto, bool>> queryExp);
	}
}
