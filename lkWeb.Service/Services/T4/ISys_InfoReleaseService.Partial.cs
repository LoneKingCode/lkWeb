...
namespace lkWeb.Service.Services
{
    public partial interface ISys_InfoReleaseService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_InfoReleaseDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_InfoReleaseDto>> GetListAsync(Expression<Func<Sys_InfoReleaseDto, bool>> queryExp);
	}
}
