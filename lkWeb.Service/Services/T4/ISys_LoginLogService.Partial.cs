...
namespace lkWeb.Service.Services
{
    public partial interface ISys_LoginLogService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_LoginLogDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_LoginLogDto>> GetListAsync(Expression<Func<Sys_LoginLogDto, bool>> queryExp);
	}
}
