...
namespace lkWeb.Service.Services
{
    public partial interface ISys_OperationLogService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_OperationLogDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_OperationLogDto>> GetListAsync(Expression<Func<Sys_OperationLogDto, bool>> queryExp);
	}
}
