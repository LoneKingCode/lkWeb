...
namespace lkWeb.Service.Services
{
    public partial interface ISys_RoleMenuService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_RoleMenuDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_RoleMenuDto>> GetListAsync(Expression<Func<Sys_RoleMenuDto, bool>> queryExp);
	}
}
