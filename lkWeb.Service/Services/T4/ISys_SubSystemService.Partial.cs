...
namespace lkWeb.Service.Services
{
    public partial interface ISys_SubSystemService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_SubSystemDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_SubSystemDto>> GetListAsync(Expression<Func<Sys_SubSystemDto, bool>> queryExp);
	}
}
