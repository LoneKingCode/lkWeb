...
namespace lkWeb.Service.Services
{
    public partial interface ISys_SystemOptionService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_SystemOptionDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_SystemOptionDto>> GetListAsync(Expression<Func<Sys_SystemOptionDto, bool>> queryExp);
	}
}
