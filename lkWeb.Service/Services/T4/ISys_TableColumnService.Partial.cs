...
namespace lkWeb.Service.Services
{
    public partial interface ISys_TableColumnService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_TableColumnDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_TableColumnDto>> GetListAsync(Expression<Func<Sys_TableColumnDto, bool>> queryExp);
	}
}
