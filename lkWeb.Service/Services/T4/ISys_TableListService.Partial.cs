...
namespace lkWeb.Service.Services
{
    public partial interface ISys_TableListService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<PageResult<Sys_TableListDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<PageResult<Sys_TableListDto>> GetListAsync(Expression<Func<Sys_TableListDto, bool>> queryExp);
	}
}
