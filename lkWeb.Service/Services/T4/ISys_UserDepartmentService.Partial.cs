...
namespace lkWeb.Service.Services
{
    public partial interface ISys_UserDepartmentService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_UserDepartmentDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_UserDepartmentDto>> GetListAsync(Expression<Func<Sys_UserDepartmentDto, bool>> queryExp);
	}
}
