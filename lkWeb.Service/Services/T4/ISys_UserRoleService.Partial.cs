...
namespace lkWeb.Service.Services
{
    public partial interface ISys_UserRoleService
    {
	  /// <summary>
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_UserRoleDto>> GetPageDataAsync(QueryBase queryBase,
        ...
        /// <returns></returns>
        Task<ResultDto<Sys_UserRoleDto>> GetListAsync(Expression<Func<Sys_UserRoleDto, bool>> queryExp);
	}
}
