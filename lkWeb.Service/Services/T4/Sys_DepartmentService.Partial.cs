...
namespace lkWeb.Service.Services
{
    public partial class Sys_DepartmentService : ServiceBase<Sys_DepartmentEntity>, ISys_DepartmentService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_DepartmentDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_DepartmentDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_DepartmentEntity>();
                var result = new ResultDto<Sys_DepartmentDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_DepartmentDto>> GetListAsync(Expression<Func<Sys_DepartmentDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
