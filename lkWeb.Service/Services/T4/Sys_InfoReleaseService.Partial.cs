...
namespace lkWeb.Service.Services
{
    public partial class Sys_InfoReleaseService : ServiceBase<Sys_InfoReleaseEntity>, ISys_InfoReleaseService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_InfoReleaseDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_InfoReleaseDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_InfoReleaseEntity>();
                var result = new PageResult<Sys_InfoReleaseDto>();
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_InfoReleaseDto>> GetListAsync(Expression<Func<Sys_InfoReleaseDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
