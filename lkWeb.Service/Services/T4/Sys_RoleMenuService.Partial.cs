...
namespace lkWeb.Service.Services
{
    public partial class Sys_RoleMenuService : ServiceBase<Sys_RoleMenuEntity>, ISys_RoleMenuService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_RoleMenuDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_RoleMenuDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_RoleMenuEntity>();
                var result = new ResultDto<Sys_RoleMenuDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_RoleMenuDto>> GetListAsync(Expression<Func<Sys_RoleMenuDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
