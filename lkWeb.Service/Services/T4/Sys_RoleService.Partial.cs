...
namespace lkWeb.Service.Services
{
    public partial class Sys_RoleService : ServiceBase<Sys_RoleEntity>, ISys_RoleService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_RoleDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_RoleDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_RoleDto>> GetListAsync(Expression<Func<Sys_RoleDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
