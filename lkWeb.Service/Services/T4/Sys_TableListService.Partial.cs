...
namespace lkWeb.Service.Services
{
    public partial class Sys_TableListService : ServiceBase<Sys_TableListEntity>, ISys_TableListService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_TableListDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_TableListDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_TableListEntity>();
                var result = new PageResult<Sys_TableListDto>();
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_TableListDto>> GetListAsync(Expression<Func<Sys_TableListDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
