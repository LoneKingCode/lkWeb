...
namespace lkWeb.Service.Services
{
    public partial class Sys_UserDepartmentService : ServiceBase<Sys_UserDepartmentEntity>, ISys_UserDepartmentService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_UserDepartmentDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_UserDepartmentDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_UserDepartmentEntity>();
                var result = new PageResult<Sys_UserDepartmentDto>();
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_UserDepartmentDto>> GetListAsync(Expression<Func<Sys_UserDepartmentDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
