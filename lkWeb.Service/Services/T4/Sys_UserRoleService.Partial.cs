...
namespace lkWeb.Service.Services
{
    public partial class Sys_UserRoleService : ServiceBase<Sys_UserRoleEntity>, ISys_UserRoleService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_UserRoleDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_UserRoleDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_UserRoleEntity>();
                var result = new PageResult<Sys_UserRoleDto>();
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_UserRoleDto>> GetListAsync(Expression<Func<Sys_UserRoleDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
