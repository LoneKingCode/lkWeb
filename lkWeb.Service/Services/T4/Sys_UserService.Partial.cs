...
namespace lkWeb.Service.Services
{
    public partial class Sys_UserService : ServiceBase<Sys_UserEntity>, ISys_UserService
    {
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_UserDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_UserDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_UserEntity>();
                var result = new ResultDto<Sys_UserDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<Sys_UserDto>> GetListAsync(Expression<Func<Sys_UserDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
