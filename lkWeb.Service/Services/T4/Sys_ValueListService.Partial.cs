...
namespace lkWeb.Service.Services
{
    public partial class Sys_ValueListService : ServiceBase<Sys_ValueListEntity>, ISys_ValueListService
    {
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_ValueListDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<Sys_ValueListDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
                var ds = db.Set<Sys_ValueListEntity>();
                var result = new PageResult<Sys_ValueListDto>();
        ...
        /// <returns></returns>
        public async Task<PageResult<Sys_ValueListDto>> GetListAsync(Expression<Func<Sys_ValueListDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
