...
namespace lkWeb.Areas.Admin.Controllers
{
    public class ValueListController : AdminBaseController
    {
        ...
        public async Task<IActionResult> Add(UrlParameter param)
        {
            ...
            var result = await _valueListService.GetListAsync(item => item.ParentId == 0 || item.ParentId == null);
        ...
        {
            var result = await _valueListService.GetListAsync(item => item.ParentId == null || item.ParentId == 0);
