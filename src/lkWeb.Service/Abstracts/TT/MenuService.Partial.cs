...
namespace lkWeb.Service.Abstracts
{
    public partial class MenuService : ServiceBase<MenuEntity>, IMenuService
    {
        ...
        /// <returns></returns>
        public async Task<Result<List<MenuDto>>> AddAsync(List<MenuDto> dtos)
        {
            using (var db = GetDb())
            {
        ...
        /// <param name="dtos">menu集合</param>
        /// <returns></returns>
        public async Task<Result<List<MenuDto>>> UpdateAsync(List<MenuDto> dtos)
        {
            using (var db = GetDb())
            {
                var result = new Result<List<MenuDto>>();
        ...
        /// <returns></returns>
        public async Task<Result<MenuDto>> DeleteAsync(int id)
        {
            using (var db = GetDb())
            {
                var result = new Result<MenuDto>();
        ...
        /// <returns></returns>
        public async Task<Result<List<MenuDto>>> DeleteAsync(List<int> ids)
        {
            using (var db = GetDb())
            {
                var result = new Result<List<MenuDto>>();
        ...
        /// <param name="dto">menu实体</param>
        /// <returns></returns>
        public async Task<Result<MenuDto>> DeleteAsync(MenuDto dto)
        {
            using (var db = GetDb())
            {
                var result = new Result<MenuDto>();
        ...
        /// <returns></returns>
        public async Task<ResultDto<MenuDto>> GetPageDataAsync(QueryBase queryBase, Expression<Func<MenuDto, bool>> queryExp, string orderBy, string orderDir)
        {
            using (var db = GetDb())
            {
        ...
        /// <returns></returns>
        public async Task<ResultDto<MenuDto>> GetListAsync(Expression<Func<MenuDto, bool>> queryExp)
        {
            using (var db = GetDb())
            {
        ...
        /// <returns></returns>
        public async Task<Result<MenuDto>> GetByExpAsync(Expression<Func<MenuDto, bool>> exp)
        {
            using (var db = GetDb())
            {
                var result = new Result<MenuDto>();
        ...
        /// <param name="exp"></param>
        /// <returns></returns>
        public async Task<Result<MenuDto>> DeleteAsync(Expression<Func<MenuDto, bool>> exp)
        {
            using (var db = GetDb())
            {
                var result = new Result<MenuDto>();
